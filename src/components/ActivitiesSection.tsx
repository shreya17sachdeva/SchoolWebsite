  ...
  return (
    <section id="activities" className="py-20 bg-section-gradient">
      <div className="container mx-auto px-4">
        ...
        {/* Checklist below the images */}
        <div className="flex flex-wrap justify-center gap-4">
          {activities.map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="flex items-center gap-4 bg-card rounded-xl px-5 py-4 shadow-sm border border-border hover:border-primary/30 hover:shadow-md transition-all w-full sm:w-[calc(50%-8px)] md:w-[calc(33.333%-11px)]"
            >
